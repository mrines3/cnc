function calculateSqft(buildingSpace,BAUGrowth){
    let codaSqft = scenarios.coda.getAddSqft()[0];
    ...
    for(let i=0;i<buildingSpace.year.length;i++){
        ...
        buildingSpace.other.sqft[i] = (buildingSpace.labLayer.sqft[9] + buildingSpace.classLayer.sqft[9] + buildingSpace.healthLayer.sqft[9] + buildingSpace.residLayer.sqft[9] + buildingSpace.plantLayer.sqft[9])*(1/0.93-1) + codaSqft[i];
